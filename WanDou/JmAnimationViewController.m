...
@interface JmAnimationViewController ()
<UIScrollViewDelegate,TablebarViewDelegate>

@end

@implementation JmAnimationViewController
...
{
    JmAnimation *animationTabbar = [[JmAnimation alloc]initWithFrame:CGRectMake(0, 60, 400, 44)];
    animationTabbar.delegate = self;
    [self.view addSubview:animationTabbar];
}
