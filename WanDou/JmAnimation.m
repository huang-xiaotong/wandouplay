...
-(UIScrollView *)creatScrollview
{
    ...
    m_scrollViewButton.contentSize = CGSizeMake(400, 0);
...
-(void)buttonarray
{
    ...
    _button3 = [self creatButton:CGRectMake(buttonwide * 2, 0, buttonwide, buttonhight) :@"日漫" :2005 :m_scrollViewButton :@selector(buttonPress:)];
    _button4 = [self creatButton:CGRectMake(buttonwide * 3, 0, buttonwide, buttonhight) :@"少儿" :2006 :m_scrollViewButton :@selector(buttonPress:)];
    _button5 = [self creatButton:CGRectMake(buttonwide * 4, 0, buttonwide, buttonhight) :@"追新番" :2007 :m_scrollViewButton :@selector(buttonPress:)];
}
