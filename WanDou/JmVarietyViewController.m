...
#import "JmVariety.h"
@interface JmVarietyViewController ()
<UIScrollViewDelegate,TablebarViewDelegate>

@end

@implementation JmVarietyViewController
...
{
    JmVariety *varietyTabbar = [[JmVariety alloc]initWithFrame:CGRectMake(0, 60, 400, 44)];
    varietyTabbar.delegate = self;
    [self.view addSubview:varietyTabbar];
}
